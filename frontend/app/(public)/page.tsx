...
export default function LandingPage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative overflow-hidden border-b border-white/10 aurora-bg">
        ...
        <div className="relative container mx-auto px-6 py-24 md:py-32">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mb-6 text-5xl font-bold tracking-tight text-slate-50 md:text-6xl lg:text-7xl">
              <Typewriter>The Operating System for</Typewriter>
              <br />
              <Typewriter className="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">
